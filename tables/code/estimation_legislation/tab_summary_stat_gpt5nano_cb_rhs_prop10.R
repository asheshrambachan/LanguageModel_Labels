# Table: Summary statistics for normalized bias and coverage for Monte Carlo simulations on congressional legislation using policy topic as a covariate
...
tab_path <- file.path(tab_dir, "tab_summary_stat_gpt5nano_cb_rhs_prop10.tex")
