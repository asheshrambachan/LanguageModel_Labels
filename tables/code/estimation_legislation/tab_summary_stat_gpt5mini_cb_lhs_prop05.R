# Table: Summary statistics for normalized bias and coverage across Monte Carlo
# simulations based on Congressional legislation, GPT-5-mini.
...
data_path <- file.path(repo_dir, "estimation_legislation/data/lhs_5k_plugin_validation_debiased_averaged_summary_stat.csv")
tab_path <- file.path(tab_dir, "tab_summary_stat_gpt5mini_cb_lhs_prop05.tex")
