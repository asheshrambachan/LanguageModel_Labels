# Table: Summary statistics for normalized bias and coverage for Monte Carlo simulations on congressional legislation using policy topic as a covariate, GPT-4o.
# Dec 16, 2024
...
tab_path <- file.path(tab_dir, "tab_summary_stat_gpt4o_cb_rhs_prop10.tex")
