...
data_path <- file.path(repo_dir, "prediction_cb/Data/prediction_passage_rates.csv")
tab_path <- file.path(tab_dir, "tab_prediction_cb_passage_rate_true_and_gpt4o_base_prompt.tex")
