# Figure: Variation in t-statistics for abnormal returns across large language models and prompting strategies on financial news headlines, q4, confidence, 1 day
# Dec 12, 2024
...
data_path <- file.path(repo_dir, "headlines/data/step9_reg_results/abnormal_CAPM_returns_clustered.csv")
fig_path <- file.path(fig_dir, "fig_tscores_headlines_abnormal_q4_confidence_1_day.jpeg")
fig_width <- 9
fig_height <- 4
