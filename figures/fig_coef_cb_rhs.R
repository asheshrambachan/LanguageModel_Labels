...
data_llm_path <- file.path(repo_dir, "congressional_bills/Data/Estimation/rhs_10k_llm.csv")
data_human_path <- file.path(repo_dir, "congressional_bills/Data/Estimation/rhs_10k_human.csv")
