...
data_path <- file.path(repo_dir, "cb_prediction/Data/bills_llm_completion_similarity.csv")
fig_path <- file.path(fig_dir, "fig_exact_completion_gpt4o_without_date_cb.tex")
