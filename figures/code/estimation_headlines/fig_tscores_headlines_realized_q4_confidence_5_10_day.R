# Figure: Variation in t-statistics for realized returns across large language models and prompting strategies on financial news headlines, q4, confidence, 5 and 10 days
# Dec 12, 2024
...
fig_path <- file.path(fig_dir, "fig_tscores_headlines_realized_q4_confidence_5_10_day.jpeg")
fig_width <- 9
fig_height <- 4.5
