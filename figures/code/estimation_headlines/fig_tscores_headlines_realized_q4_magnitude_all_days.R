# Figure: Variation in t-statistics for realized returns across large language models and prompting strategies on financial news headlines, q4, magnitude.
# Dec 12, 2024
...
fig_path <- file.path(fig_dir, "fig_tscores_headlines_realized_q4_magnitude_all_days.jpeg")
fig_width <- 7
fig_height <- 5.75
