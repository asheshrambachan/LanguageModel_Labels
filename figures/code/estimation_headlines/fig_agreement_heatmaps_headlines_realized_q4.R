# Figure: Variation in pairwise agreement between large language model labels across prompting strategies on financial news headlines, q4
# Dec 10, 2024
...
data_paths <- list(
  "GPT-3.5-Turbo" = file.path(repo_dir, "estimation_headlines/data/step6_common_sample/within_model/realized/gpt-3.5-turbo/q4"),
  "GPT-4o" = file.path(repo_dir, "estimation_headlines/data/step6_common_sample/within_model/realized/gpt-4o/q4"),
  "GPT-4o-mini" = file.path(repo_dir, "estimation_headlines/data/step6_common_sample/within_model/realized/gpt-4o-mini/q4"),
  "GPT-5-mini" = file.path(repo_dir, "estimation_headlines/data/step6_common_sample/within_model/realized/gpt-5-mini/q4"),
  "GPT-5-nano" = file.path(repo_dir, "estimation_headlines/data/step6_common_sample/within_model/realized/gpt-5-nano/q4")
)
...
if (min(agreement_matrices$agreement, na.rm = TRUE) < heatmap_global_min)
  stop(sprintf("Correct heatmap_global_min to be %f", heatmap_global_min))
if (max(agreement_matrices$agreement, na.rm = TRUE) > heatmap_global_max)
  stop(sprintf("Correct heatmap_global_max to be %f", heatmap_global_max))
