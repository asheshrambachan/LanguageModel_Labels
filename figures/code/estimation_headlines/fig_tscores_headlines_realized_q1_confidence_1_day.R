# Figure: Variation in t-statistics for realized returns across large language models and prompting strategies on financial news headlines, q1, confidence, 1 day
# Dec 12, 2024
...
fig_path <- file.path(fig_dir, "fig_tscores_headlines_realized_q1_confidence_1_day.jpeg")
fig_width <- 9
fig_height <- 4
