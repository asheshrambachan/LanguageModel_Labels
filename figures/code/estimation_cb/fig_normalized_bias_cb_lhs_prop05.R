# Figure: Normalized bias of the plug-in regression and bias-corrected regression across Monte Carlo simulations based on congressional legislation.
# Dec 10, 2024
...
data_path <- file.path(repo_dir, "estimation_cb/Data/lhs_5k_plugin_validation_debiased_averaged.csv")
fig_path <- file.path(fig_dir, "fig_normalized_bias_cb_lhs_prop05.jpeg")
fig_width <- 9
fig_height <- 4
