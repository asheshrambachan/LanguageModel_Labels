...
data_path <- file.path(repo_dir, "prediction_cb/Data/completion_exact_examples.csv")
fig_path <- file.path(fig_dir, "fig_completion_exact_gpt4o_cb_prompt_with_date.tex")
