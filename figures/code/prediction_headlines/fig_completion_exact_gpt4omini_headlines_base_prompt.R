# Figure: Two examples of GPT-4o-mini completions that exactly match original financial news headlines.
# Dec 10, 2024
...
fig_path <- file.path(fig_dir, "fig_completion_exact_gpt4omini_headlines_base_prompt.tex")
