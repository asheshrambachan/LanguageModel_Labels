# Figure: Two examples of GPT-3.5 completions that exactly match original financial news headlines.
# Dec 10, 2024
...
fig_path <- file.path(fig_dir, "fig_completion_exact_gpt3_headlines_base_prompt.tex")
