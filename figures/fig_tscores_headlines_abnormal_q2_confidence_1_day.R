# Figure: Variation in t-statistics for abnormal returns across large language models and prompting strategies on financial news headlines, q2, confidence, 1 day
# Dec 12, 2024
...
fig_path <- file.path(fig_dir, "fig_tscores_headlines_abnormal_q2_confidence_1_day.jpeg")
fig_width <- 9
fig_height <- 4
