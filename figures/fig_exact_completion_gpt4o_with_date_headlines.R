# Figure: Examples of GPT-4o completions with date restriction that exactly match original financial news headlines.
# Dec 10, 2024
...
fig_path <- file.path(fig_dir, "figA02_headlines_completion_exact_gpt4o_with_date.tex")
