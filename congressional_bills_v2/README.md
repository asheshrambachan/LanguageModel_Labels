...
- `./Code`: contains both R and Python scripts used to construct the empirical
  analysis and simulation study.
- `./Data`: contains all input data files that are used to construct the
  empirical analyses and simulation study. The directory is also used to
  store the processed data generated by the replication files.
...
The primary data sources are listed below. You don’t need to download the data separately as this is done in the notebook.
