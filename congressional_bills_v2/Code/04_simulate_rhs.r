...
path.utils <- file.path(path.repo_dir, "04_simulation/utils.r")
path.combinations <- file.path(path.repo_dir, "04_simulation/output/rhs/combinations.csv")
path.rds_dir <- file.path(path.repo_dir, "04_simulation/output/rhs/rds")
path.log <- file.path(path.repo_dir, "04_simulation/output/rhs/output.log")
...
data <- read.csv(path.data) %>% 
  ...
  mutate(
    Model = if_else(Model=="gpt-3.5-turbo-0125", "gpt-3.5", Model),
