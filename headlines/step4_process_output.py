...
output_file_path = 'batch_dec19_output.jsonl'
...
output['explanation'] = output['explanation'].str.lower()
...
data['headline type num'] = data['headline type'].map({'positive': 2, 'neutral': 1, 'negative': 0})
