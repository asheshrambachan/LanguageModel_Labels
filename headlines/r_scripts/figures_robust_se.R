...
pos_retcomp
ggsave(filename = "temp_figs/t_stat_comparison/robust_ses/pos_ret_q5.jpeg", units = "in", width = 7, height = 4)
...
neg_retcomp
ggsave(filename = "temp_figs/t_stat_comparison/robust_ses/neg_ret_q5.jpeg", units = "in", width = 7, height = 4)
