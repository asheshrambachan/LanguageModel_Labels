...
# Data and table paths
data_bills_path <- file.path(repo_dir, "Data/Estimation/bills.csv")
data_llm_path <- file.path(repo_dir, "Data/Estimation/LHS/lhs_10k_llm.csv")
tab_path <- file.path(tab_dir, "tab03_cb_lhs_variation_point_est_prop10.tex")
