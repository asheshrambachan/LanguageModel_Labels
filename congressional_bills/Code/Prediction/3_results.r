...
data_fig02 <- data_fig02 %>%
  ...
  group_by(Model, AddIntrDate, Chamber) %>%
  summarise(
...
ggsave(file.path(fig_dir, "fig02 Accuracy of Bill Pass Predictions vs. Intro Date.jpeg"), height = 4, width = 8)
