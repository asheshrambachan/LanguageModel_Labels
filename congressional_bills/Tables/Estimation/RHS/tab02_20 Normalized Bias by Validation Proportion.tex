...
\caption{\label{tab:unnamed-chunk-1}Normalized Bias Summary Statistics of $\beta_{t}$, $t=$ Public Lands and Water Management, by Proportion of Validation Samples.
