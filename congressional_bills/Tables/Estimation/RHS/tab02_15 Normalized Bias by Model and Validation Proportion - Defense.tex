...
\caption{Normalized Bias Summary Statistics of $\beta_{t}$, $t=$ Defense, by Model and Proportion of Validation Samples. Proxy on the RHS: $V = Y^\top \beta = \sum_{t} Y_t \beta_t$.}
\centering
