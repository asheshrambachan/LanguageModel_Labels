...
\caption{\label{tab:unnamed-chunk-1}Normalized Bias Summary Statistics of $\beta_{t}$, $t=$ Banking, Finance, and Domestic Commerce, by Model and Proportion of Validation Samples.
