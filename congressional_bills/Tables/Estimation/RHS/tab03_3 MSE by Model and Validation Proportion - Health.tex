...
\caption{MSE Summary Statistics of $\beta_{t}$, $t=$ Health, by Model and Proportion of Validation Samples. Proxy on the RHS: $V = Y^\top \beta = \sum_{t} Y_t \beta_t$.}
\centering
