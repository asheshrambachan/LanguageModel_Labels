...
\caption{\label{tab:unnamed-chunk-2}MSE Summary Statistics of $\beta_{t}$, $t=$ Banking, Finance, and Domestic Commerce, by Model and Proportion of Validation Samples.
