...
\caption{Bias Summary Statistics of $\beta_{t}$, $t=$ Defense, by Model and Proportion of Validation Samples. Proxy on the RHS: $V = Y^\top \beta = \sum_{t} Y_t \beta_t$.}
\centering
...
GPT-4o & 10\% & Validation & 0.000 & 0.002 & 0.000 & -0.003 & 0.004\\
...
GPT-4o & 50\% & Validation & 0.000 & 0.001 & 0.000 & -0.002 & 0.001\\
