...
\caption{\label{tab:unnamed-chunk-1}Normalized Bias Summary Statistics by Model and Proportion of Validation Samples for $\beta$. Proxy on the LHS: $Y = \alpha + \beta V$.}
\centering
